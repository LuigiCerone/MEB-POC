...
public class DatabaseRawData {
    ...
    public static final String URL = "jdbc:mysql://localhost/raw_data";
    ...
    public DataSource setUp() throws Exception {
        ...
        Class.forName(DatabaseRawData.DRIVER).newInstance();
        ...
        ConnectionFactory cf = new DriverManagerConnectionFactory(
                DatabaseRawData.URL,
                DatabaseRawData.USERNAME,
                DatabaseRawData.PASSWORD);
